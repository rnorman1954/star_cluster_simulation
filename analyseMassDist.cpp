 ...
 *
 *         Output consists of the 10 numbers representing the frequency of stars
...
const int num_bins = 30;        //The number of sorting bins
const real mass_max = 30.0;    //The largest mass allowable for the distribution
...
int main(int argc, char *argv[]) {
    ...
    //real binWidth = 0.1/n;    //Stellar masses equal to 1/n
    real binWidth = mass_max/num_bins;  //Stellar masses in ratios of M_sun

    //Read and categorise masses
    real dummy;                            //used to discard the other values in the file.
    for(int i = 0; i < n; i++) {
    ...
    out.close();
            ...
            if (pipe != NULL)
            {
                ...
                fprintf(pipe, "set term x11\n");     //set the terminal to x11 for Gnome desktop
                fprintf(pipe, "set key off\n");
                fprintf(pipe, "set xrange [0:*]\n");
                ...
                fprintf(pipe, "plot 'histo.txt' using 2:xtic(1) ti col\n");    // plot data from temp file
